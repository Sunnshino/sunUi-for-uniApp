	...
	<view class="m-t45">
		<!-- <view class="cu-custom" :style="'height:'+CustomBar+'px;'">
			<view class="cu-bar fixed bg-gradual-blue" :style="'height:'+CustomBar+'px;padding-top'+StatusBar+'px;'">
				<navigator class='action' open-type="navigateBack" hover-class="none">
		...
		<scroll-view scroll-x class="bg-white nav text-center fixed">
			<view class="cu-item" :class="index==TabCur?'text-blue cur':''" v-for="(item,index) in tabNav" :key='index' @click='tabSelect' :data-id="index">
				{{tabNav[index]}}
			</view>
		</scroll-view>
		...
		<block v-if="TabCur==1">
			...
			<view class="bg-white padding">
				<view class="grid col-4 grid-square">
					<view class="bg-img" v-for="(item,index) in 4" :key='index' :style="'background-image:url(https://image.weilanwl.com/img/square-'+index+1+'}}.jpg);'"></view>
				</view>
			</view>
		</block>
		<block v-if="TabCur==2">
